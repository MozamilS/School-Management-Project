...
public class AdminDashboardController {
    public void ClassesButtonAction(ActionEvent actionEvent) {
        loadStage("Classes.fxml", actionEvent);

    }

    public void StudentsButtonAction(ActionEvent actionEvent) {
        loadStage("Students.fxml", actionEvent);
    }
